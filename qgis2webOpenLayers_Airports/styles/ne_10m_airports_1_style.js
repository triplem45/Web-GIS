...
function categories_ne_10m_airports_1(feature, value, size, resolution, labelText,
                       ...
                       placement) {
                switch(value.toString()) {case 'Mid Airport':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 3.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(31,47,196,1.0)'})}),
